...
<%
    ...
    if (nivelUsuario == null || !nivelUsuario.equals("corretor")) {
...
<%//variaveis para o menu
    ...
    String menu1 = "cliente-compra";
    String menu2 = "vendedores";
    String menu3 = "imoveis";
    String menu4 = "tarefas";
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.jsp?pag=<%=menu1%>">Compradores</a>
                            <a class="collapse-item" href="index.jsp?pag=<%=menu2%>">Vendedores</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp?pag=<%=menu3%>">
